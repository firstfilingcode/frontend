...
function DigitalSignatureNriClass3() {
  return (
    <>
      <Header />
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-7">
            ...
            >
              ...
              <p />
              <p>
                GST registration usually takes between 2-6 working days. Team
                Clear can help you obtain GST registration faster in 3 easy
                steps.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for 15CA-15CB-CERTIFICATE</li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The 15CA-15CB-CERTIFICATE Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                GST registration can be obtained on the GST portal. One must
                apply for GST registration in Form REG-01 on the GST portal
                following steps outlined in our article “How to apply for GST
                registration?”. However, the GST registration services at
        ...
        >
          ...
          >
            ...
            <h4>
              <span className="slash_right">15CA-15CB-CERTIFICATE Fees</span>
            </h4>
            <p>
              15CA-15CB-CERTIFICATE is a tedious 11 step process that involves
              the submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the GST law for
              obtaining GST registration on the GST portal on your own, you can
              save a huge time and effort by purchasing the GST registration
              plan with ClearTax.
            </p>
            <p>
              You can opt for Clear 15CA-15CB-CERTIFICATE services where a GST
              Expert will assist you, end to end with 15CA-15CB-CERTIFICATE.
            </p>
            <h4>
              <span className="slash_right">
...
export default DigitalSignatureNriClass3;

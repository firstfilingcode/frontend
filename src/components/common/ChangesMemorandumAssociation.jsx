...
function ChangesMemorandumAssociation() {
  return (
    <>
      <Header />
      <div className="container">
          ...
          <div className="col-md-7">
            ...
            >
              <span className="secondrowheading slash_right">
                What is Cancel GST Registration?
              </span>
              <p className="Tax">
                Under Goods And Services Tax (Cancel GST Registration),
                businesses whose turnover exceeds the threshold limitof Rs.40
                lakh or Rs.20 lakh or Rs.10 lakh as the case may be, must
                register as a normal taxable person. It is called Cancel GST
                Registration.
              </p>
              <p>
                For certain businesses, Fillings under Cancel GST Registration
                is mandatory. If the organization carries on business without
                registering under Cancel GST Registration, it is an offence
                under Cancel GST Registration and heavy penalties will apply.
              </p>
              obtain Cancel GST Registration faster in 3 easy steps.
              <p />
              <p>
                Cancel GST Registration usually takes between 2-6 working days.
                Team Clear can help you obtain Cancel GST Registration faster in
                3 easy steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Cancel GST Registration</li>
                <li>Secure Cancel GST Registration Identification Number</li>
                <li>
                  Dedicated manager to process your Cancel GST Registration end
                  to end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted Cancel GST Registration Filing for all your Cancel
            ...
            <p className="textdetail">
              * Get Clear Cancel GST Registration invoicing and digital khata
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Cancel GST Registration?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-Cancel GST Registration
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Cancel GST Registration Process</span>
            </div>
          </h3>
        </div>
        ...
        <div className="row gstRow" data-aos="fade-right" data-aos-delay="500">
          ...
          <div className="col-md-2 gstbg-6">
            ...
            <p>Cancel GST RegistrationIN Received</p>
          </div>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Cancel GST  Registration can be obtained on the Cancel GST  Registration portal. One must
                apply for Cancel GST  Registration in Form REG-01 on the Cancel GST  Registration portal
                following steps outlined in our article “How to apply for Cancel GST  Registration
                Fillings?”. However, the Cancel GST  Registration services at
                ClearTax helps you to get your business Cancel GST  Registration registered and
                obtain your Cancel GST  RegistrationIN. Clear Cancel GST  Registration experts will guide you on the
                applicability and compliances under Cancel GST  Registration for your business and
                get your business registered under Cancel GST  Registration.
              </p>
          ...
          >
            <h4>
              <span className="slash_right">
                Documents Required for Cancel GST Registration
              </span>
            </h4>
            ...
            <h4>
              <span className="slash_right">Cancel GST Registration Fees</span>
            </h4>
            <p>
              Cancel GST Registration is a tedious 11 step process that involves
              the submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the Cancel GST
              Registration law for obtaining Cancel GST Registration on the
              Cancel GST Registration portal on your own, you can save a huge
              time and effort by purchasing the Cancel GST Registration plan
              with ClearTax.
            </p>
            <p>
              You can opt for Clear Cancel GST Registration services where a
              Cancel GST Registration Expert will assist you, end to end with
              Cancel GST Registration.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Cancel GST Registration
              </span>
            </h4>
            <p>
...
export default ChangesMemorandumAssociation;

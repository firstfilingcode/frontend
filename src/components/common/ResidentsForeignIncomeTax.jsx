...
function ResidentsForeignIncomeTax() {
  return (
    <>
          ...
          <div className="col-md-7">
            ...
            >
              ...
              <p className="Tax">
                ...
                person. It is called Financial Services .
              </p>
              <p>
              ...
              obtain Financial Services faster in 3 easy steps.
              <p />
              <p>
                Financial Services usually takes between 2-6 working days. Team
                Clear can help you obtain Financial Services faster in 3 easy
                steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Financial Services </li>
                <li>Secure GST Identification Number</li>
                <li>
                  Dedicated manager to process your Financial Services end to
                  end
                </li>
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Financial Services ?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Financial Services Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Financial Services  can be obtained on the GST portal. One must
                apply for Financial Services  in Form REG-01 on the GST portal
                following steps outlined in our article “How to apply for GST
                registration?”. However, the Financial Services  services at
          ...
          >
            <h4>
              <span className="slash_right">
                Documents Required for Financial Services
              </span>
            </h4>
            ...
            <h4>
              <span className="slash_right">Financial Services Fees</span>
            </h4>
            <p>
              Financial Services is a tedious 11 step process that involves the
              submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the GST law for
              obtaining Financial Services on the GST portal on your own, you
              can save a huge time and effort by purchasing the Financial
              Services plan with ClearTax.
            </p>
            <p>
              You can opt for Clear Financial Services services where a GST
              Expert will assist you, end to end with Financial Services .
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Financial Services
              </span>
            </h4>
            <p>
...
export default ResidentsForeignIncomeTax;

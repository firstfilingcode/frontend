      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-7">
            ...
            >
              ...
              <p className="Tax">
                Under Goods And Services Tax (TAX), businesses whose turnover
                exceeds the threshold limitof Rs.40 lakh or Rs.20 lakh or Rs.10
                lakh as the case may be, must register as a normal taxable
                person. It is called TAX Registration.
              </p>
              <p>
                For certain businesses, filling under Tax is mandatory. If the
                organization carries on business without registering under TAX
                Registration, it is an offence under Tax and heavy penalties
                will apply.
              </p>
              obtain Tax Registration faster in 3 easy steps.
              <p />
              <p>
                TAX Registration usually takes between 2-6 working days. Team
                Clear can help you obtain TAX Registration faster in 3 easy
                steps.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for TAX Registration</li>
                <li>Secure TAX Identification Number</li>
                <li>
                  Dedicated manager to process your TAX Registration end to end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>CA Assisted TAX Registration for all your TAX needs</li>
                <li>CA Assisted TAX Registration for all your TAX needs</li>
                <li>CA Assisted TAX Registration for all your TAX needs</li>
              </ul>
            </div>
            <p className="textdetail">
              * Get Clear TAX invoicing and digital khata app free with this
              service
            </p>
          </div>
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the TAX Registration?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-TAX law (i.e., Excise,
                  VAT, Service Tax etc.)
                </li>
                <li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The TAX Registration Process</span>
            </div>
          </h3>
        </div>
          ...
          {/* <div className="col-md-6 gstRegistrationBack" data-aos="fade-left" data-aos-delay="500">
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                TAX Registration can be obtained on the TAX portal. One must
                apply for TAX Registration in Form REG-01 on the TAX portal
                following steps outlined in our article “How to apply for TAX
                registration?”. However, the TAX Registration services at
                ClearTax helps you to get your business TAX registered and
                obtain your TAX. Clear TAX experts will guide you on the
                applicability and compliances under TAX for your business and
                get your business registered under TAX.
              </p>

              <p className="web-color gsttext3">
                TAX Registration can be obtained on the TAX portal. One must
                apply for TAX Registration in Form REG-01 on the TAX portal
                following steps outlined in our article “How to apply for TAX Registration?”. 
                However, the TAX Registration services at
                ClearTax helps you to get your business TAX registered and
                obtain your TAX. Clear TAX experts will guide you on the
                applicability and compliances under TAX for your business and
                get your business registered under TAX.
        ...
        >
          ...
          >
            ...
            <h4>
              <span className="slash_right">TAX Registration Fees</span>
            </h4>
            <p>
              TAX Registration is a tedious 11 step process that involves the
              submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the TAX law for
              obtaining GST registration on the TAX portal on your own, you can
              save a huge time and effort by purchasing the TAX Registration
              plan with ClearTax.
            </p>
            <p>
              You can opt for Clear TAX Registration services where a TAX Expert
              will assist you, end to end with TAX Registration.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining TAX Registration
              </span>
            </h4>
            <p>
...
export default MsmeComplianceTradmarkRegistration;

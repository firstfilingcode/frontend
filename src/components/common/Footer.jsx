...
import footerLogo from "../common/Images/firstfiling.png";
        ...
        <div className="container footer-top">
          <div className="row">
            <div className="col-md-6 col-first">
              ...
              <p>
              &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; At First Filing Company, we believe that financial success is not just about numbers, it's about building long-lasting relationships with our clients. Our commitment to excellence, integrity, and personalized service has earned us the trust and loyalty of our clients, making us a leading financial services provider in the industry. We make sure businesses stay compliant and up-to-date with the latest regulations. Working hard to keep your business running smoothly. 
                ...
                <div className="col-md-6">
                  <div className="footer-links">
                    ...
                    <div className="links-tag">
                      ...
                      <div>
                        <NavLink to="/CancellationRefundPolicy">
          ...
          <p className="text-center text-white copyright">
            © 2022 MAAVALAN CONSULTANCY PRIVATE LIMITED
          </p>
        </div>
      </div>
    </>

...
function CryptocurrencyTaxationAdvisory() {
  return (
    <>
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-7">
            ...
            >
              ...
              <p className="Tax">
                Under Goods And Services Tax (Investment Advisor), businesses
                ...
                taxable person. It is called Investment Advisor.
              </p>
              <p>
                For certain businesses, Fillings under Investment Advisor is
                mandatory. If the organization carries on business without
                registering under Investment Advisor, it is an offence under
                Investment Advisor and heavy penalties will apply.
              </p>
              obtain Investment Advisor faster in 3 easy steps.
              <p />
              <p>
                Investment Advisor usually takes between 2-6 working days. Team
                Clear can help you obtain Investment Advisor faster in 3 easy
                steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Investment Advisor</li>
                <li>Secure Investment Advisor Identification Number</li>
                <li>
                  Dedicated manager to process your Investment Advisor end to
                  end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted Investment Advisor Filing for all your Investment
                  Advisor needs
                </li>
                <li>
                  CA Assisted Investment Advisor Filing for all your Investment
            ...
            <p className="textdetail">
              * Get Clear Investment Advisor invoicing and digital khata app
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Investment Advisor?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-Investment Advisor law
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Investment Advisor Process</span>
            </div>
          </h3>
        </div>
        ...
        <div className="row gstRow" data-aos="fade-right" data-aos-delay="500">
          ...
          <div className="col-md-2 gstbg-6">
            ...
            <p>Investment AdvisorIN Received</p>
          </div>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Investment Advisor can be obtained on the Investment Advisor portal. One must
                apply for Investment Advisor in Form REG-01 on the Investment Advisor portal
                following steps outlined in our article “How to apply for Investment Advisor
                Fillings?”. However, the Investment Advisor services at
                ClearTax helps you to get your business Investment Advisor registered and
                obtain your Investment AdvisorIN. Clear Investment Advisor experts will guide you on the
                applicability and compliances under Investment Advisor for your business and
                get your business registered under Investment Advisor.
              </p>
          ...
          >
            <h4>
              <span className="slash_right">
                Documents Required for Investment Advisor
              </span>
            </h4>
            ...
            <h4>
              <span className="slash_right">Investment Advisor Fees</span>
            </h4>
            <p>
              Investment Advisor is a tedious 11 step process that involves the
              submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the Investment Advisor
              law for obtaining Investment Advisor on the Investment Advisor
              portal on your own, you can save a huge time and effort by
              purchasing the Investment Advisor plan with ClearTax.
            </p>
            <p>
              You can opt for Clear Investment Advisor services where a
              Investment Advisor Expert will assist you, end to end with
              Investment Advisor.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Investment Advisor
              </span>
            </h4>
            <p>
...
export default CryptocurrencyTaxationAdvisory;

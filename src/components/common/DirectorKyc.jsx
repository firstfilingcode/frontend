      ...
      <div className="container">
          ...
          <div className="col-md-7">
            ...
            >
              ...
              <p className="Tax">
                ...
                person. It is called DOCS OF DSC.
              </p>
              <p>
              ...
              obtain DOCS OF DSC faster in 3 easy steps.
              <p />
              <p>
                DOCS OF DSC usually takes between 2-6 working days. Team Clear
                can help you obtain DOCS OF DSC faster in 3 easy steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          <div
            ...
            data-aos-delay="500"
          >
            <h3 className="firstrowheadind slash_right">DOCS OF DSC Online</h3>
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for DOCS OF DSC</li>
                <li>Secure GST Identification Number</li>
                <li>
                  Dedicated manager to process your DOCS OF DSC end to end
                </li>
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the DOCS OF DSC?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The DOCS OF DSC Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                DOCS OF DSC can be obtained on the GST portal. One must
                apply for DOCS OF DSC in Form REG-01 on the GST portal
                following steps outlined in our article “How to apply for GST
                registration?”. However, the DOCS OF DSC services at
          ...
          >
            <h4>
              <span className="slash_right">
                Documents Required for DOCS OF DSC
              </span>
            </h4>
            ...
            <h4>
              <span className="slash_right">DOCS OF DSC Fees</span>
            </h4>
            <p>
              DOCS OF DSC is a tedious 11 step process that involves the
              submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the GST law for
              obtaining DOCS OF DSC on the GST portal on your own, you can save
              a huge time and effort by purchasing the DOCS OF DSC plan with
              ClearTax.
            </p>
            <p>
              You can opt for Clear DOCS OF DSC services where a GST Expert will
              assist you, end to end with DOCS OF DSC.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining DOCS OF DSC
              </span>
            </h4>
            <p>

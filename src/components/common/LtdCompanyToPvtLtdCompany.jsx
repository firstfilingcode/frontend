...
function LtdCompanyToPvtLtdCompany() {
  return (
    <>
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-7">
            ...
            >
              ...
              obtain EPF Registration faster in 3 easy steps.
              <p />
              <p>
                EPF Registration usually takes between 2-6 working days. Team
                Clear can help you obtain EPF Registration faster in 3 easy
                steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for EPF Registration</li>
                <li>Secure GST Identification Number</li>
                <li>
                  Dedicated manager to process your EPF Registration end to end
                </li>
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the EPF Registration?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The EPF Registration Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                EPF Registration can be obtained on the GST portal. One must
                apply for EPF Registration in Form REG-01 on the GST portal
                following steps outlined in our article “How to apply for GST
                registration?”. However, the EPF Registration services at
        ...
        >
          ...
          >
            ...
            <h4>
              <span className="slash_right">EPF Registration Fees</span>
            </h4>
            <p>
              EPF Registration is a tedious 11 step process that involves the
              submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the GST law for
              obtaining EPF Registration on the GST portal on your own, you can
              save a huge time and effort by purchasing the EPF Registration
              plan with ClearTax.
            </p>
            <p>
              You can opt for Clear EPF Registration services where a GST Expert
              will assist you, end to end with EPF Registration.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining EPF Registration
              </span>
            </h4>
            <p>
...
export default LtdCompanyToPvtLtdCompany;

      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-7">
            ...
            >
              ...
              <p className="Tax">
                Under Goods And Services Tax (Consultancy Services), businesses
                ...
                taxable person. It is called Consultancy Services.
              </p>
              <p>
                For certain businesses, Fillings under Consultancy Services is
                mandatory. If the organization carries on business without
                registering under Consultancy Services, it is an offence under
                Consultancy Services and heavy penalties will apply.
              </p>
              obtain Consultancy Services faster in 3 easy steps.
              <p />
              <p>
                Consultancy Services usually takes between 2-6 working days.
                Team Clear can help you obtain Consultancy Services faster in 3
                easy steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Consultancy Services</li>
                <li>Secure Consultancy Services Identification Number</li>
                <li>
                  Dedicated manager to process your Consultancy Services end to
                  end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted Consultancy Services Filing for all your
                  Consultancy Services needs
                </li>
                <li>
                  CA Assisted Consultancy Services Filing for all your
                  Consultancy Services needs
            ...
            <p className="textdetail">
              * Get Clear Consultancy Services invoicing and digital khata app
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Consultancy Services?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-Consultancy Services law
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Consultancy Services Process</span>
            </div>
          </h3>
        </div>
        ...
        <div className="row gstRow" data-aos="fade-right" data-aos-delay="500">
          ...
          <div className="col-md-2 gstbg-6">
            ...
            <p>Consultancy ServicesIN Received</p>
          </div>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Consultancy Services can be obtained on the Consultancy Services portal. One must
                apply for Consultancy Services in Form REG-01 on the Consultancy Services portal
                following steps outlined in our article “How to apply for Consultancy Services
                Fillings?”. However, the Consultancy Services services at
                ClearTax helps you to get your business Consultancy Services registered and
                obtain your Consultancy ServicesIN. Clear Consultancy Services experts will guide you on the
                applicability and compliances under Consultancy Services for your business and
                get your business registered under Consultancy Services.
              </p>
          ...
          >
            <h4>
              <span className="slash_right">
                Documents Required for Consultancy Services
              </span>
            </h4>
            ...
            <h4>
              <span className="slash_right">Consultancy Services Fees</span>
            </h4>
            <p>
              Consultancy Services is a tedious 11 step process that involves
              the submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the Consultancy
              Services law for obtaining Consultancy Services on the Consultancy
              Services portal on your own, you can save a huge time and effort
              by purchasing the Consultancy Services plan with ClearTax.
            </p>
            <p>
              You can opt for Clear Consultancy Services services where a
              Consultancy Services Expert will assist you, end to end with
              Consultancy Services.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Consultancy Services
              </span>
            </h4>
            <p>

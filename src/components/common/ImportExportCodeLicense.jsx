      ...
      <div className="container">
          ...
          <div className="col-md-7">
            ...
            >
              <span className="secondrowheading slash_right">
                What is Import Export Code License?
              </span>
              <p className="Tax">
                Under Goods And Services Tax (Import Export Code License),
                businesses whose turnover exceeds the threshold limitof Rs.40
                lakh or Rs.20 lakh or Rs.10 lakh as the case may be, must
                register as a normal taxable person. It is called Import Export
                Code License.
              </p>
              <p>
                For certain businesses, filling under Tax is mandatory. If the
                organization carries on business without registering under
                Import Export Code License, it is an offence under Tax and heavy
                penalties will apply.
              </p>
              obtain Import Export Code License faster in 3 easy steps.
              <p />
              <p>
                Import Export Code License usually takes between 2-6 working
                days. Team Clear can help you obtain Import Export Code License
        ...
        <div className="row whatisgst">
          ...
          >
            <h3 className="firstrowheadind slash_right">
              Import Export Code License Online
            </h3>
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Import Export Code License</li>
                <li>Secure TAX Identification Number</li>
                <li>
                  Dedicated manager to process your Import Export Code License
                  end to end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted Import Export Code License for all your Import
                  Export Code License needs
                </li>
                <li>
                  CA Assisted Import Export Code License for all your Import
                  Export Code License needs needs
                </li>
                <li>
                  CA Assisted Import Export Code License for all your Import
                  Export Code License needs needs
            ...
            <p className="textdetail">
              * Get Clear Import Export Code License needs invoicing and digital
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Import Export Code License?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-Import Export Code
                  License needs law (i.e., Excise, VAT, Service Tax etc.)
                </li>
                <li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Import Export Code License Process</span>
            </div>
          </h3>
        </div>
          ...
          {/* <div className="col-md-6 gstRegistrationBack" data-aos="fade-left" data-aos-delay="500">
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Import Export Code License can be obtained on the Import Export Code License needs portal. One must
                apply for Import Export Code License in Form REG-01 on the Import Export Code License needs portal
                following steps outlined in our article “How to apply for Import Export Code License needs
                registration?”. However, the Import Export Code License services at
                ClearTax helps you to get your business Import Export Code License needs registered and
                obtain your Import Export Code License needs. Clear Import Export Code License needs experts will guide you on the
                applicability and compliances under Import Export Code License needs for your business and
                get your business registered under Import Export Code License needs.
              </p>

              <p className="web-color gsttext3">
                Import Export Code License can be obtained on the Import Export Code License needs portal. One must
                apply for Import Export Code License in Form REG-01 on the Import Export Code License needs portal
                following steps outlined in our article “How to apply for Import Export Code License?”. 
                However, the Import Export Code License services at
                ClearTax helps you to get your business Import Export Code License needs registered and
                obtain your Import Export Code License needs. Clear Import Export Code License needs experts will guide you on the
                applicability and compliances under Import Export Code License needs for your business and
                get your business registered under Import Export Code License needs.
        ...
        >
          ...
          >
            ...
            <h4>
              <span className="slash_right">
                Import Export Code License Fees
              </span>
            </h4>
            <p>
              Import Export Code License is a tedious 11 step process that
              involves the submission of many business details and scanned
              documents.
            </p>
            <p>
              Although there are no fees prescribed under the Import Export Code
              License needs law for obtaining GST registration on the TAX portal
              on your own, you can save a huge time and effort by purchasing the
              Import Export Code License plan with ClearTax.
            </p>
            <p>
              You can opt for Clear Import Export Code License services where a
              Import Export Code License needs Expert will assist you, end to
              end with Import Export Code License.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Import Export Code License
              </span>
            </h4>
            <p>

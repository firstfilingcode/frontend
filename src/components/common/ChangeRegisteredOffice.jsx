      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-7">
            ...
            <div
              ...
              data-aos-delay="800"
            >
              <span className="secondrowheading slash_right">What is ESI?</span>
              <p className="Tax">
                Under Goods And Services Tax (ESI(EMPLOYEE STOCK RETURNS)),
                businesses whose turnover exceeds the threshold limitof Rs.40
                lakh or Rs.20 lakh or Rs.10 lakh as the case may be, must
                register as a normal taxable person. It is called ESI.
              </p>
              <p>
                For certain businesses, filling under Tax is mandatory. If the
                organization carries on business without registering under
                ESI(EMPLOYEE STOCK RETURNS), it is an offence under Tax and
                heavy penalties will apply.
              </p>
              obtain ESI faster in 3 easy steps.
              <p />
              <p>
                ESI(EMPLOYEE STOCK RETURNS) usually takes between 2-6 working
                days. Team Clear can help you obtain ESI(EMPLOYEE STOCK RETURNS)
        ...
        <div className="row whatisgst">
          <div
            ...
            data-aos-delay="500"
          >
            <h3 className="firstrowheadind slash_right">ESI Online</h3>
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for ESI(EMPLOYEE STOCK RETURNS)</li>
                <li>Secure TAX Identification Number</li>
                <li>
                  Dedicated manager to process your ESI(EMPLOYEE STOCK RETURNS)
                  end to end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted ESI(EMPLOYEE STOCK RETURNS) for all your
                  ESI(EMPLOYEE STOCK RETURNS) needs
                </li>
                <li>
                  CA Assisted ESI(EMPLOYEE STOCK RETURNS) for all your
                  ESI(EMPLOYEE STOCK RETURNS) needs needs
                </li>
                <li>
                  CA Assisted ESI(EMPLOYEE STOCK RETURNS) for all your
                  ESI(EMPLOYEE STOCK RETURNS) needs needs
            ...
            <p className="textdetail">
              * Get Clear ESI(EMPLOYEE STOCK RETURNS) needs invoicing and
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the ESI?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-ESI(EMPLOYEE STOCK
                  RETURNS) needs law (i.e., Excise, VAT, Service Tax etc.)
                </li>
                <li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The ESI Process</span>
            </div>
          </h3>
        </div>
          ...
          {/* <div className="col-md-6 gstRegistrationBack" data-aos="fade-left" data-aos-delay="500">
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                ESI(EMPLOYEE STOCK RETURNS) can be obtained on the ESI(EMPLOYEE STOCK RETURNS) needs portal. One must
                apply for ESI(EMPLOYEE STOCK RETURNS) in Form REG-01 on the ESI(EMPLOYEE STOCK RETURNS) needs portal
                following steps outlined in our article “How to apply for ESI(EMPLOYEE STOCK RETURNS) needs
                registration?”. However, the ESI(EMPLOYEE STOCK RETURNS) services at
                ClearTax helps you to get your business ESI needs registered and
                obtain your ESI needs. Clear ESI(EMPLOYEE STOCK RETURNS) needs experts will guide you on the
                applicability and compliances under ESI(EMPLOYEE STOCK RETURNS) needs for your business and
                get your business registered under ESI(EMPLOYEE STOCK RETURNS) needs.
              </p>

              <p className="web-color gsttext3">
                ESI can be obtained on the ESI(EMPLOYEE STOCK RETURNS) needs portal. One must
                apply for ESI(EMPLOYEE STOCK RETURNS) in Form REG-01 on the ESI(EMPLOYEE STOCK RETURNS) needs portal
                following steps outlined in our article “How to apply for ESI(EMPLOYEE STOCK RETURNS)?”. 
                However, the ESI(EMPLOYEE STOCK RETURNS) services at
                ClearTax helps you to get your business ESI(EMPLOYEE STOCK RETURNS) needs registered and
                obtain your ESI(EMPLOYEE STOCK RETURNS) needs. Clear ESI(EMPLOYEE STOCK RETURNS) needs experts will guide you on the
                applicability and compliances under ESI(EMPLOYEE STOCK RETURNS) needs for your business and
                get your business registered under ESI(EMPLOYEE STOCK RETURNS) needs.
              </p>
            </section>
        ...
        >
          ...
          >
            <h4>
              <span className="slash_right">Documents Required for ESI</span>
            </h4>
            ...
            <h4>
              <span className="slash_right">ESI Fees</span>
            </h4>
            <p>
              ESI(EMPLOYEE STOCK RETURNS) is a tedious 11 step process that
              involves the submission of many business details and scanned
              documents.
            </p>
            <p>
              Although there are no fees prescribed under the ESI(EMPLOYEE STOCK
              RETURNS) needs law for obtaining GST registration on the TAX
              portal on your own, you can save a huge time and effort by
              purchasing the ESI(EMPLOYEE STOCK RETURNS) plan with ClearTax.
            </p>
            <p>
              You can opt for Clear ESI(EMPLOYEE STOCK RETURNS) services where a
              ESI(EMPLOYEE STOCK RETURNS) needs Expert will assist you, end to
              end with ESI(EMPLOYEE STOCK RETURNS).
            </p>
            <h4>
              <span className="slash_right">Penalty for not obtaining ESI</span>
            </h4>
            <p>

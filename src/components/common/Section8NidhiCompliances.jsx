...
function Section8NidhiCompliances() {
  return (
    <>
          ...
          <div className="col-md-7">
            ...
            >
              <span className="secondrowheading slash_right">
                What is ADVISORY ON TAX SAVING ?
              </span>
              <p className="Tax">
                ...
                person. It is called ADVISORY ON TAX SAVING .
              </p>
              <p>
              ...
              obtain ADVISORY ON TAX SAVING faster in 3 easy steps.
              <p />
              <p>
                ADVISORY ON TAX SAVING usually takes between 2-6 working days.
                Team Clear can help you obtain ADVISORY ON TAX SAVING faster in
                3 easy steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for ADVISORY ON TAX SAVING </li>
                <li>Secure GST Identification Number</li>
                <li>
                  Dedicated manager to process your ADVISORY ON TAX SAVING end
                  to end
                </li>
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the ADVISORY ON TAX SAVING ?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The ADVISORY ON TAX SAVING Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                ADVISORY ON TAX SAVING can be obtained on the GST portal. One
                must apply for ADVISORY ON TAX SAVING in Form REG-01 on the GST
                portal following steps outlined in our article “How to apply for
                GST registration?”. However, the ADVISORY ON TAX SAVING services
                at ClearTax helps you to get your business GST registered and
          ...
          >
            <h4>
              <span className="slash_right">
                Documents Required for ADVISORY ON TAX SAVING
              </span>
            </h4>
            ...
            <h4>
              <span className="slash_right">ADVISORY ON TAX SAVING Fees</span>
            </h4>
            <p>
              ADVISORY ON TAX SAVING is a tedious 11 step process that involves
              the submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the GST law for
              obtaining ADVISORY ON TAX SAVING on the GST portal on your own,
              you can save a huge time and effort by purchasing the ADVISORY ON
              TAX SAVING plan with ClearTax.
            </p>
            <p>
              You can opt for Clear ADVISORY ON TAX SAVING services where a GST
              Expert will assist you, end to end with ADVISORY ON TAX SAVING .
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining ADVISORY ON TAX SAVING
              </span>
            </h4>
            <p>
...
export default Section8NidhiCompliances;

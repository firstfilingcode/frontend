...
function ProprietorshipFirmRegistration() {
  return (
    <>
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-7">
            ...
            >
              ...
              <p className="Tax">
                Under Goods And Services Tax (Proprietorship Firm Registration),
                businesses whose turnover exceeds the threshold limitof Rs.40
                lakh or Rs.20 lakh or Rs.10 lakh as the case may be, must
                register as a normal taxable person. It is called Proprietorship
                Firm Registration.
              </p>
              <p>
                For certain businesses, filling under Tax is mandatory. If the
                organization carries on business without registering under
                Proprietorship Firm Registration, it is an offence under Tax and
                heavy penalties will apply.
              </p>
              obtain Proprietorship Firm Registration faster in 3 easy steps.
              <p />
              <p>
                Proprietorship Firm Registration usually takes between 2-6
                working days. Team Clear can help you obtain Proprietorship Firm
                Registration faster in 3 easy steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Filing of Application for Proprietorship Firm Registration
                </li>
                <li>Secure TAX Identification Number</li>
                <li>
                  Dedicated manager to process your Proprietorship Firm
                  Registration end to end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted Proprietorship Firm Registration for all your
                  Proprietorship Firm Registration needs
                </li>
                <li>
                  CA Assisted Proprietorship Firm Registration for all your
                  Proprietorship Firm Registration needs needs
                </li>
                <li>
                  CA Assisted Proprietorship Firm Registration for all your
                  Proprietorship Firm Registration needs needs
            ...
            <p className="textdetail">
              * Get Clear Proprietorship Firm Registration needs invoicing and
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Proprietorship Firm Registration?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-Proprietorship Firm
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            ...
            >
              <span>
                All About The Proprietorship Firm Registration Process
              </span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Proprietorship Firm Registration can be obtained on the
                Proprietorship Firm Registration needs portal. One must apply
                for Proprietorship Firm Registration in Form REG-01 on the
                Proprietorship Firm Registration needs portal following steps
                outlined in our article “How to apply for Proprietorship Firm
                Registration needs registration?”. However, the Proprietorship
                Firm Registration services at ClearTax helps you to get your
                business Proprietorship Firm Registration needs registered and
                obtain your Proprietorship Firm Registration needs. Clear
                Proprietorship Firm Registration needs experts will guide you on
                the applicability and compliances under Proprietorship Firm
                Registration needs for your business and get your business
                registered under Proprietorship Firm Registration needs.
              </p>
              ...
              <p className="web-color gsttext3">
                ...
                Proprietorship Firm Registration needs portal following steps
                outlined in our article “How to apply for Proprietorship Firm
                Registration?”. However, the Proprietorship Firm Registration
                services at ClearTax helps you to get your business
                Proprietorship Firm Registration needs registered and obtain
                your Proprietorship Firm Registration needs. Clear
                Proprietorship Firm Registration needs experts will guide you on
                the applicability and compliances under Proprietorship Firm
                Registration needs for your business and get your business
                registered under Proprietorship Firm Registration needs.
        ...
        >
          ...
          >
            ...
            <p>
              Proprietorship Firm Registration is a tedious 11 step process that
              involves the submission of many business details and scanned
              documents.
            </p>
            <p>
              Although there are no fees prescribed under the Proprietorship
              Firm Registration needs law for obtaining GST registration on the
              TAX portal on your own, you can save a huge time and effort by
              purchasing the Proprietorship Firm Registration plan with
              ClearTax.
            </p>
            <p>
              You can opt for Clear Proprietorship Firm Registration services
              where a Proprietorship Firm Registration needs Expert will assist
              you, end to end with Proprietorship Firm Registration.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Proprietorship Firm Registration
              </span>
            </h4>
            <p>

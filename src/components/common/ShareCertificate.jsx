          ...
          <div className="col-md-7">
            ...
            >
              ...
              <p className="Tax">
                ...
                person. It is called Share Certificate.
              </p>
              <p>
              ...
              obtain Share Certificate faster in 3 easy steps.
              <p />
              <p>
                Share Certificate usually takes between 2-6 working days. Team
                Clear can help you obtain Share Certificate faster in 3 easy
                steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Share Certificate</li>
                <li>Secure GST Identification Number</li>
                <li>
                  Dedicated manager to process your Share Certificate end to end
                </li>
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Share Certificate?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Share Certificate Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Share Certificate can be obtained on the GST portal. One must
                apply for Share Certificate in Form REG-01 on the GST portal
                following steps outlined in our article “How to apply for GST
                registration?”. However, the Share Certificate services at
          ...
          >
            <h4>
              <span className="slash_right">
                Documents Required for Share Certificate
              </span>
            </h4>
            ...
            <h4>
              <span className="slash_right">Share Certificate Fees</span>
            </h4>
            <p>
              Share Certificate is a tedious 11 step process that involves the
              submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the GST law for
              obtaining Share Certificate on the GST portal on your own, you can
              save a huge time and effort by purchasing the Share Certificate
              plan with ClearTax.
            </p>
            <p>
              You can opt for Clear Share Certificate services where a GST
              Expert will assist you, end to end with Share Certificate.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Share Certificate
              </span>
            </h4>
            <p>

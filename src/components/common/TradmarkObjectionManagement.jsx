...
function TradmarkObjectionManagement() {
  return (
    <>
      <Header />
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-7">
            ...
            >
              ...
              <p className="Tax">
                Under Goods And Services Tax (Share Transfer), businesses whose
                ...
                taxable person. It is called Share Transfer.
              </p>
              <p>
                For certain businesses, Fillings under Share Transfer is
                mandatory. If the organization carries on business without
                registering under Share Transfer, it is an offence under Share
                Transfer and heavy penalties will apply.
              </p>
              obtain Share Transfer faster in 3 easy steps.
              <p />
              <p>
                Share Transfer usually takes between 2-6 working days. Team
                Clear can help you obtain Share Transfer faster in 3 easy steps.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Share Transfer</li>
                <li>Secure Share Transfer Identification Number</li>
                <li>
                  Dedicated manager to process your Share Transfer end to end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted Share Transfer Filing for all your Share Transfer
                  needs
                </li>
                <li>
                  CA Assisted Share Transfer Filing for all your Share Transfer
            ...
            <p className="textdetail">
              * Get Clear Share Transfer invoicing and digital khata app free
              with this service
            </p>
          </div>
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Share Transfer?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-Share Transfer law (i.e.,
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Share Transfer Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Share Transfer can be obtained on the Share Transfer portal. One
                must apply for Share Transfer in Form REG-01 on the Share
                Transfer portal following steps outlined in our article “How to
                apply for Share Transfer Fillings?”. However, the Share Transfer
                services at ClearTax helps you to get your business Share
                Transfer registered and obtain your Share TransferIN. Clear
                Share Transfer experts will guide you on the applicability and
                compliances under Share Transfer for your business and get your
                business registered under Share Transfer.
              </p>
        ...
        >
          ...
          >
            ...
            <h4>
              <span className="slash_right">Share Transfer Fees</span>
            </h4>
            <p>
              Share Transfer is a tedious 11 step process that involves the
              submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the Share Transfer law
              for obtaining Share Transfer on the Share Transfer portal on your
              own, you can save a huge time and effort by purchasing the Share
              Transfer plan with ClearTax.
            </p>
            <p>
              You can opt for Clear Share Transfer services where a Share
              Transfer Expert will assist you, end to end with Share Transfer.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Share Transfer
              </span>
            </h4>
            <p>
...
export default TradmarkObjectionManagement;

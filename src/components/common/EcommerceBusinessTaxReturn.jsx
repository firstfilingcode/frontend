...
function EcommerceBusinessTaxReturn() {
  return (
    <>
      <div className="container">
          ...
          <div className="col-md-7">
            ...
            >
              <span className="secondrowheading slash_right">
                What is Change In MOA/AOA?
              </span>
              <p className="Tax">
                Under Goods And Services Tax (Change In MOA/AOA), businesses
                ...
                taxable person. It is called Change In MOA/AOA.
              </p>
              <p>
                For certain businesses, Fillings under Change In MOA/AOA is
                mandatory. If the organization carries on business without
                registering under Change In MOA/AOA, it is an offence under
                Change In MOA/AOA and heavy penalties will apply.
              </p>
              obtain Change In MOA/AOA faster in 3 easy steps.
              <p />
              <p>
                Change In MOA/AOA usually takes between 2-6 working days. Team
                Clear can help you obtain Change In MOA/AOA faster in 3 easy
                steps.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Change In MOA/AOA</li>
                <li>Secure Change In MOA/AOA Identification Number</li>
                <li>
                  Dedicated manager to process your Change In MOA/AOA end to end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted Change In MOA/AOA Filing for all your Change In
                  MOA/AOA needs
                </li>
                <li>
                  CA Assisted Change In MOA/AOA Filing for all your Change In
            ...
            <p className="textdetail">
              * Get Clear Change In MOA/AOA invoicing and digital khata app free
              with this service
            </p>
          </div>
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Change In MOA/AOA?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-Change In MOA/AOA law
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Change In MOA/AOA Process</span>
            </div>
          </h3>
        </div>
        ...
        <div className="row gstRow" data-aos="fade-right" data-aos-delay="500">
          ...
          <div className="col-md-2 gstbg-6">
            ...
            <p>Change In MOA/AOAIN Received</p>
          </div>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Change In MOA/AOA can be obtained on the Change In MOA/AOA portal. One must
                apply for Change In MOA/AOA in Form REG-01 on the Change In MOA/AOA portal
                following steps outlined in our article “How to apply for Change In MOA/AOA
                Fillings?”. However, the Change In MOA/AOA services at
                ClearTax helps you to get your business Change In MOA/AOA registered and
                obtain your Change In MOA/AOAIN. Clear Change In MOA/AOA experts will guide you on the
                applicability and compliances under Change In MOA/AOA for your business and
                get your business registered under Change In MOA/AOA.
              </p>
        ...
        >
          ...
          >
            ...
            <h4>
              <span className="slash_right">Change In MOA/AOA Fees</span>
            </h4>
            <p>
              Change In MOA/AOA is a tedious 11 step process that involves the
              submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the Change In MOA/AOA
              law for obtaining Change In MOA/AOA on the Change In MOA/AOA
              portal on your own, you can save a huge time and effort by
              purchasing the Change In MOA/AOA plan with ClearTax.
            </p>
            <p>
              You can opt for Clear Change In MOA/AOA services where a Change In
              MOA/AOA Expert will assist you, end to end with Change In MOA/AOA.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Change In MOA/AOA
              </span>
            </h4>
            <p>
...
export default EcommerceBusinessTaxReturn;

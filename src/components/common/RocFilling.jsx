      ...
      <div className="container">
        ...
        <div className="row whatisgst">
          <div
            ...
            data-aos-delay="500"
          >
            <h3 className="firstrowheadind slash_right">ROC Filling Online</h3>
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for ROC Filling</li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The ROC Filling Process</span>
            </div>
          </h3>
        </div>
        ...
        >
          ...
          >
            ...
            <h4>
              <span className="slash_right">ROC Filling Fees</span>
            </h4>
            <p>
              ROC Filling is a tedious 11 step process that involves the
            ...
            <p>
              You can opt for Clear ROC Filling services where a GST Expert will
              assist you, end to end with ROC Filling.
            </p>
            <h4>
              <span className="slash_right">

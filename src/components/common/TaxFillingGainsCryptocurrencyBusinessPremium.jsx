...
function TaxFillingGainsCryptocurrencyBusinessPremium() {
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
      ...
      <div className="container">
        ...
        <div className="col-md-12 mt-5 what_income_1 slash_1">
          <span>Recent Amendments Regarding Income Tax Return Filing</span>
        </div>
      </div>

      <div className="container">
        <div className="row">
          <div className="col-md-12 mt-5 why_first_filing">
            <p>
              The penalty for not filing an income tax return is serious and can
              have a long-term impact on an individual’s financial health.
            </p>
          ...
          <div className="col-md-12 mb-3">
            <div class="gstlist_10 gstlist_32 incomelispace">
              <ul>
                <li>
                  The term accounting period is replaced by calendar year ending
                  as on 31 December 2021 in the new ITR Forms which means that
                  now the assess needs to furnish all the details of the foreign
                  assets held by him between 1 January 2021 to 31 December 2021
                  in ITR for AY 2022-23
                </li>
                <li>
                  Starting from FY 2020 -21 the amount of late fees is reduced
                  from 10,000 to 5000 for the people whose income is above 5 lac
                  but there is no change for the tax payers whose income is less
                  than 5 Lack. The penalty is same as earlier i.e. Rs. 1000
                </li>
              </ul>
            </div>
          </div>
...
export default TaxFillingGainsCryptocurrencyBusinessPremium;

...
import incometax_men2 from "../common/Images/questionMark5.png";
import Presumptive12 from "../common/Images/Presumptive12.png";
import Presumptive11 from "../common/Images/calculator5.png";
import Presumptive10 from "../common/Images/Thumsup5.png";
import Presumptive9 from "../common/Images/TAX5.png";
...
function TaxFillingGainsCryptocurrencyIndividual() {
  ...
  return (
    <>
      ...
      <section>
        <section className="sevicesBack7">
          <ServiceType2 />
        </section>
      </section>
      ...
      <div className="container">
        <div className="row paddingtopBottom">
          ...
          <div className="col-md-5">
            <section className="text-center">
              <img src={Presumptive11} alt="Presumptive11" width={"200px"} height={"300px"} />
              <NavLink to="/Contact">    <button className="btn itrFIleButton">
                Schedule Free Consultation
              </button> </NavLink>
            </section>
        ...
        <div className="row">
          ...
          <div className="col-md-5">
            <section className="text-center">
              <img src={Presumptive10} alt="Presumptive10" width={"200px"} heigh={"300px"} className="mobileImg" />
              <NavLink to="/Contact">    <button className="btn itrFIleButton">
                Schedule Free Consultation
              </button> </NavLink>
            </section>
...
export default TaxFillingGainsCryptocurrencyIndividual;

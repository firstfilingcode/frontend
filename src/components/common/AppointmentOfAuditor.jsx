      ...
      <div className="container">
          ...
          <div className="col-md-7">
            ...
            >
              ...
              <p className="Tax">
                ...
                person. It is called APPOINTMENT OF AUDITOR .
              </p>
              <p>
              ...
              obtain APPOINTMENT OF AUDITOR faster in 3 easy steps.
              <p />
              <p>
                APPOINTMENT OF AUDITOR usually takes between 2-6 working days.
                Team Clear can help you obtain APPOINTMENT OF AUDITOR faster in
                3 easy steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for APPOINTMENT OF AUDITOR </li>
                <li>Secure GST Identification Number</li>
                <li>
                  Dedicated manager to process your APPOINTMENT OF AUDITOR end
                  to end
                </li>
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the APPOINTMENT OF AUDITOR ?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The APPOINTMENT OF AUDITOR Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                APPOINTMENT OF AUDITOR  can be obtained on the GST portal. One must
                apply for APPOINTMENT OF AUDITOR  in Form REG-01 on the GST portal
                following steps outlined in our article “How to apply for GST
                registration?”. However, the APPOINTMENT OF AUDITOR  services at
        ...
        >
          ...
          >
            ...
            <h4>
              <span className="slash_right">APPOINTMENT OF AUDITOR Fees</span>
            </h4>
            <p>
              APPOINTMENT OF AUDITOR is a tedious 11 step process that involves
              the submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the GST law for
              obtaining APPOINTMENT OF AUDITOR on the GST portal on your own,
              you can save a huge time and effort by purchasing the APPOINTMENT
              OF AUDITOR plan with ClearTax.
            </p>
            <p>
              You can opt for Clear APPOINTMENT OF AUDITOR services where a GST
              Expert will assist you, end to end with APPOINTMENT OF AUDITOR .
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining APPOINTMENT OF AUDITOR
              </span>
            </h4>
            <p>
...
export default AppointmentOfAuditor;

...
function TradmarkRenewalCompany() {
  return (
    <>
      <Header />
          ...
          <div className="col-md-7">
            ...
            >
              <span className="secondrowheading slash_right">
                What is Tan Allotment?
              </span>
              <p className="Tax">
                Under Goods And Services Tax (Tan Allotment), businesses whose
                ...
                taxable person. It is called Tan Allotment.
              </p>
              <p>
                For certain businesses, Fillings under Tan Allotment is
                mandatory. If the organization carries on business without
                registering under Tan Allotment, it is an offence under Tan
                Allotment and heavy penalties will apply.
              </p>
              obtain Tan Allotment faster in 3 easy steps.
              <p />
              <p>
                Tan Allotment usually takes between 2-6 working days. Team Clear
                can help you obtain Tan Allotment faster in 3 easy steps.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Tan Allotment</li>
                <li>Secure Tan Allotment Identification Number</li>
                <li>
                  Dedicated manager to process your Tan Allotment end to end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted Tan Allotment Filing for all your Tan Allotment
                  needs
                </li>
                <li>
                  CA Assisted Tan Allotment Filing for all your Tan Allotment
            ...
            <p className="textdetail">
              * Get Clear Tan Allotment invoicing and digital khata app free
              with this service
            </p>
          </div>
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Tan Allotment?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-Tan Allotment law (i.e.,
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Tan Allotment Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Tan Allotment can be obtained on the Tan Allotment portal. One
                must apply for Tan Allotment in Form REG-01 on the Tan Allotment
                portal following steps outlined in our article “How to apply for
                Tan Allotment Fillings?”. However, the Tan Allotment services at
                ClearTax helps you to get your business Tan Allotment registered
                and obtain your Tan AllotmentIN. Clear Tan Allotment experts
                will guide you on the applicability and compliances under Tan
                Allotment for your business and get your business registered
                under Tan Allotment.
              </p>
          ...
          >
            <h4>
              <span className="slash_right">
                Documents Required for Tan Allotment
              </span>
            </h4>
            ...
            <h4>
              <span className="slash_right">Tan Allotment Fees</span>
            </h4>
            <p>
              Tan Allotment is a tedious 11 step process that involves the
              submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the Tan Allotment law
              for obtaining Tan Allotment on the Tan Allotment portal on your
              own, you can save a huge time and effort by purchasing the Tan
              Allotment plan with ClearTax.
            </p>
            <p>
              You can opt for Clear Tan Allotment services where a Tan Allotment
              Expert will assist you, end to end with Tan Allotment.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Tan Allotment
              </span>
            </h4>
            <p>
...
export default TradmarkRenewalCompany;

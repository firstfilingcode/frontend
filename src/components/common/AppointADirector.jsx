      ...
      <div className="container">
          ...
          <div className="col-md-7">
            ...
            >
              ...
              <p className="Tax">
                ...
                person. It is called APEDA Registration.
              </p>
              <p>
              ...
              obtain APEDA Registration faster in 3 easy steps.
              <p />
              <p>
                APEDA Registration usually takes between 2-6 working days. Team
                Clear can help you obtain APEDA Registration faster in 3 easy
                steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for APEDA Registration</li>
                <li>Secure GST Identification Number</li>
                <li>
                  Dedicated manager to process your APEDA Registration end to
                  end
                </li>
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the APEDA Registration?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The APEDA Registration Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                APEDA Registration can be obtained on the GST portal. One must
                apply for APEDA Registration in Form REG-01 on the GST portal
                following steps outlined in our article “How to apply for GST
                registration?”. However, the APEDA Registration services at
        ...
        >
          ...
          >
            ...
            <h4>
              <span className="slash_right">APEDA Registration Fees</span>
            </h4>
            <p>
              APEDA Registration is a tedious 11 step process that involves the
              submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the GST law for
              obtaining APEDA Registration on the GST portal on your own, you
              can save a huge time and effort by purchasing the APEDA
              Registration plan with ClearTax.
            </p>
            <p>
              You can opt for Clear APEDA Registration services where a GST
              Expert will assist you, end to end with APEDA Registration.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining APEDA Registration
              </span>
            </h4>
            <p>
...
export default AppointADirector;

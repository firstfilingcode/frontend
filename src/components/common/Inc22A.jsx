      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-7">
            ...
            >
              ...
              <p className="Tax">
                Under Goods And Services Tax (INC-22A), businesses whose
                ...
                taxable person. It is called INC-22A.
              </p>
              <p>
                For certain businesses, Fillings under INC-22A is mandatory. If
                the organization carries on business without registering under
                INC-22A, it is an offence under INC-22A and heavy penalties will
                apply.
              </p>
              obtain INC-22A faster in 3 easy steps.
              <p />
              <p>
                INC-22A usually takes between 2-6 working days. Team Clear can
                help you obtain INC-22A faster in 3 easy steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          <div
            ...
            data-aos-delay="500"
          >
            <h3 className="firstrowheadind slash_right">INC-22A Online</h3>
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for INC-22A</li>
                <li>Secure INC-22A Identification Number</li>
                <li>Dedicated manager to process your INC-22A end to end</li>
                <li>Completely Online – No need to visit office</li>
                <li>CA Assisted INC-22A Filing for all your INC-22A needs</li>
                <li>CA Assisted INC-22A Filing for all your INC-22A needs</li>
                <li>CA Assisted INC-22A Filing for all your INC-22A needs</li>
              </ul>
            </div>
            <p className="textdetail">
              * Get Clear INC-22A invoicing and digital khata app free with this
              service
            </p>
          </div>
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the INC-22A?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-INC-22A law (i.e.,
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The INC-22A Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                INC-22A can be obtained on the INC-22A portal. One must
                apply for INC-22A in Form REG-01 on the INC-22A portal
                following steps outlined in our article “How to apply for INC-22A
                Fillings?”. However, the INC-22A services at
                ClearTax helps you to get your business INC-22A registered and
                obtain your INC-22AIN. Clear INC-22A experts will guide you on the
                applicability and compliances under INC-22A for your business and
                get your business registered under INC-22A.
              </p>
        ...
        >
          ...
          >
            ...
            <h4>
              <span className="slash_right">INC-22A Fees</span>
            </h4>
            <p>
              INC-22A is a tedious 11 step process that involves the submission
              of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the INC-22A law for
              obtaining INC-22A on the INC-22A portal on your own, you can save
              a huge time and effort by purchasing the INC-22A plan with
              ClearTax.
            </p>
            <p>
              You can opt for Clear INC-22A services where a INC-22A Expert will
              assist you, end to end with INC-22A.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining INC-22A
              </span>
            </h4>
            <p>

          ...
          <div className="col-md-7">
            ...
            >
              <span className="secondrowheading slash_right">
                What is Companies Fresh Start Scheme?
              </span>
              <p className="Tax">
                ...
                person. It is called Companies Fresh Start Scheme.
              </p>
              <p>
              ...
              obtain Companies Fresh Start Scheme faster in 3 easy steps.
              <p />
              <p>
                Companies Fresh Start Scheme usually takes between 2-6 working
                days. Team Clear can help you obtain Companies Fresh Start
                Scheme faster in 3 easy steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          ...
          >
            <h3 className="firstrowheadind slash_right">
              Companies Fresh Start Scheme Online
            </h3>
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Companies Fresh Start Scheme</li>
                <li>Secure GST Identification Number</li>
                <li>
                  Dedicated manager to process your Companies Fresh Start Scheme
                  end to end
                </li>
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Companies Fresh Start Scheme?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Companies Fresh Start Scheme Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Companies Fresh Start Scheme can be obtained on the GST portal. One must
                apply for Companies Fresh Start Scheme in Form REG-01 on the GST portal
                following steps outlined in our article “How to apply for GST
                registration?”. However, the Companies Fresh Start Scheme services at
          ...
          >
            <h4>
              <span className="slash_right">
                Documents Required for Companies Fresh Start Scheme
              </span>
            </h4>
            ...
            <h4>
              <span className="slash_right">
                Companies Fresh Start Scheme Fees
              </span>
            </h4>
            <p>
              Companies Fresh Start Scheme is a tedious 11 step process that
              involves the submission of many business details and scanned
              documents.
            </p>
            <p>
              Although there are no fees prescribed under the GST law for
              obtaining Companies Fresh Start Scheme on the GST portal on your
              own, you can save a huge time and effort by purchasing the
              Companies Fresh Start Scheme plan with ClearTax.
            </p>
            <p>
              You can opt for Clear Companies Fresh Start Scheme services where
              a GST Expert will assist you, end to end with Companies Fresh
              Start Scheme.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Companies Fresh Start Scheme
              </span>
            </h4>
            <p>
...
export default DigitalSignatureDgft;

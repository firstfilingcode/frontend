...
function TdsReturnSalaryAndOtherPayment() {
  return (
    <>
      <Header />
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-7">
            ...
            >
              ...
              obtain Lei Code faster in 3 easy steps.
              <p />
              <p>
                Lei Code usually takes between 2-6 working days. Team Clear can
                help you obtain Lei Code faster in 3 easy steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          <div
            ...
            data-aos-delay="500"
          >
            <h3 className="firstrowheadind slash_right">Lei Code Online</h3>
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Lei Code</li>
                <li>Secure GST Identification Number</li>
                <li>Dedicated manager to process your Lei Code end to end</li>
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Lei Code?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Lei Code Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Lei Code can be obtained on the GST portal. One must apply for
                Lei Code in Form REG-01 on the GST portal following steps
                outlined in our article “How to apply for GST registration?”.
                However, the Lei Code services at ClearTax helps you to get your
                business GST registered and obtain your GSTIN. Clear GST experts
                will guide you on the applicability and compliances under GST
        ...
        >
          ...
          >
            ...
            <h4>
              <span className="slash_right">Lei Code Fees</span>
            </h4>
            <p>
              Lei Code is a tedious 11 step process that involves the submission
              of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the GST law for
              obtaining Lei Code on the GST portal on your own, you can save a
              huge time and effort by purchasing the Lei Code plan with
              ClearTax.
            </p>
            <p>
              You can opt for Clear Lei Code services where a GST Expert will
              assist you, end to end with Lei Code.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Lei Code
              </span>
            </h4>
            <p>
...
export default TdsReturnSalaryAndOtherPayment;

...
function PvtLtdCompanyToPublicLtdCompany() {
  return (
    <>
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-7">
            ...
            >
              ...
              obtain MGT14 faster in 3 easy steps.
              <p />
              <p>
                MGT14 usually takes between 2-6 working days. Team Clear can
                help you obtain MGT14 faster in 3 easy steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          <div
            ...
            data-aos-delay="500"
          >
            <h3 className="firstrowheadind slash_right">MGT14 Online</h3>
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for MGT14</li>
                <li>Secure GST Identification Number</li>
                <li>Dedicated manager to process your MGT14 end to end</li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The MGT14 Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                MGT14 can be obtained on the GST portal. One must
                apply for MGT14 in Form REG-01 on the GST portal
                following steps outlined in our article “How to apply for GST
                registration?”. However, the MGT14 services at
        ...
        >
          ...
          >
            <h4>
              <span className="slash_right">Documents Required for MGT14</span>
            </h4>
            ...
            <h4>
              <span className="slash_right">MGT14 Fees</span>
            </h4>
            <p>
              MGT14 is a tedious 11 step process that involves the submission of
              many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the GST law for
              obtaining MGT14 on the GST portal on your own, you can save a huge
              time and effort by purchasing the MGT14 plan with ClearTax.
            </p>
            <p>
              You can opt for Clear MGT14 services where a GST Expert will
              assist you, end to end with MGT14.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining MGT14
              </span>
            </h4>
            <p>
...
export default PvtLtdCompanyToPublicLtdCompany;

...
function TdsReturnSaleOfProperty() {
  return (
    <>
          ...
          <div className="col-md-7">
            ...
            >
              <span className="secondrowheading slash_right">
                What is Advice & Guidance on Excise?
              </span>
              <p className="Tax">
                ...
                person. It is called Advice & Guidance on Excise.
              </p>
              <p>
              ...
              obtain Advice & Guidance on Excise faster in 3 easy steps.
              <p />
              <p>
                Advice & Guidance on Excise usually takes between 2-6 working
                days. Team Clear can help you obtain Advice & Guidance on Excise
        ...
        <div className="row whatisgst">
          ...
          >
            <h3 className="firstrowheadind slash_right">
              Advice & Guidance on Excise Online
            </h3>
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Advice & Guidance on Excise</li>
                <li>Secure GST Identification Number</li>
                <li>
                  Dedicated manager to process your Advice & Guidance on Excise
                  end to end
                </li>
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Advice & Guidance on Excise?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Advice & Guidance on Excise Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Advice & Guidance on Excise can be obtained on the GST portal.
                One must apply for Advice & Guidance on Excise in Form REG-01 on
                the GST portal following steps outlined in our article “How to
                apply for GST registration?”. However, the Advice & Guidance on
                Excise services at ClearTax helps you to get your business GST
                registered and obtain your GSTIN. Clear GST experts will guide
                you on the applicability and compliances under GST for your
                business and get your business registered under GST.
              </p>
          ...
          >
            <h4>
              <span className="slash_right">
                Documents Required for Advice & Guidance on Excise
              </span>
            </h4>
            ...
            <h4>
              <span className="slash_right">
                Advice & Guidance on Excise Fees
              </span>
            </h4>
            <p>
              Advice & Guidance on Excise is a tedious 11 step process that
              involves the submission of many business details and scanned
              documents.
            </p>
            <p>
              Although there are no fees prescribed under the GST law for
              obtaining Advice & Guidance on Excise on the GST portal on your
              own, you can save a huge time and effort by purchasing the Advice
              & Guidance on Excise plan with ClearTax.
            </p>
            <p>
              You can opt for Clear Advice & Guidance on Excise services where a
              GST Expert will assist you, end to end with Advice & Guidance on
              Excise.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Advice & Guidance on Excise
              </span>
            </h4>
            <p>
...
export default TdsReturnSaleOfProperty;

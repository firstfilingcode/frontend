      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-7">
            ...
            >
              ...
              <p className="Tax">
                Under Goods And Services Tax (Professional Tax), businesses
                ...
                taxable person. It is called Professional Tax.
              </p>
              <p>
                For certain businesses, Fillings under Professional Tax is
                mandatory. If the organization carries on business without
                registering under Professional Tax, it is an offence under
                Professional Tax and heavy penalties will apply.
              </p>
              obtain Professional Tax faster in 3 easy steps.
              <p />
              <p>
                Professional Tax usually takes between 2-6 working days. Team
                Clear can help you obtain Professional Tax faster in 3 easy
                steps.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Professional Tax</li>
                <li>Secure Professional Tax Identification Number</li>
                <li>
                  Dedicated manager to process your Professional Tax end to end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted Professional Tax Filing for all your Professional
                  Tax needs
                </li>
                <li>
                  CA Assisted Professional Tax Filing for all your Professional
            ...
            <p className="textdetail">
              * Get Clear Professional Tax invoicing and digital khata app free
              with this service
            </p>
          </div>
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Professional Tax?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-Professional Tax law
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Professional Tax Process</span>
            </div>
          </h3>
        </div>
        ...
        <div className="row gstRow" data-aos="fade-right" data-aos-delay="500">
          ...
          <div className="col-md-2 gstbg-6">
            ...
            <p>Professional TaxIN Received</p>
          </div>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Professional Tax can be obtained on the Professional Tax portal. One must
                apply for Professional Tax in Form REG-01 on the Professional Tax portal
                following steps outlined in our article “How to apply for Professional Tax
                Fillings?”. However, the Professional Tax services at
                ClearTax helps you to get your business Professional Tax registered and
                obtain your Professional TaxIN. Clear Professional Tax experts will guide you on the
                applicability and compliances under Professional Tax for your business and
                get your business registered under Professional Tax.
              </p>
        ...
        >
          ...
          >
            ...
            <h4>
              <span className="slash_right">Professional Tax Fees</span>
            </h4>
            <p>
              Professional Tax is a tedious 11 step process that involves the
              submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the Professional Tax
              law for obtaining Professional Tax on the Professional Tax portal
              on your own, you can save a huge time and effort by purchasing the
              Professional Tax plan with ClearTax.
            </p>
            <p>
              You can opt for Clear Professional Tax services where a
              Professional Tax Expert will assist you, end to end with
              Professional Tax.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Professional Tax
              </span>
            </h4>
            <p>

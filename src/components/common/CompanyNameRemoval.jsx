      ...
      <div className="container">
          ...
          <div className="col-md-7">
            ...
            >
              <span className="secondrowheading slash_right">
                What is Change Company Name?
              </span>
              <p className="Tax">
                Under Goods And Services Tax (Change Company Name), businesses
                ...
                taxable person. It is called Change Company Name.
              </p>
              <p>
                For certain businesses, Fillings under Change Company Name is
                mandatory. If the organization carries on business without
                registering under Change Company Name, it is an offence under
                Change Company Name and heavy penalties will apply.
              </p>
              obtain Change Company Name faster in 3 easy steps.
              <p />
              <p>
                Change Company Name usually takes between 2-6 working days. Team
                Clear can help you obtain Change Company Name faster in 3 easy
                steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Change Company Name</li>
                <li>Secure Change Company Name Identification Number</li>
                <li>
                  Dedicated manager to process your Change Company Name end to
                  end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted Change Company Name Filing for all your Change
                  Company Name needs
                </li>
                <li>
                  CA Assisted Change Company Name Filing for all your Change
            ...
            <p className="textdetail">
              * Get Clear Change Company Name invoicing and digital khata app
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Change Company Name?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-Change Company Name law
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Change Company Name Process</span>
            </div>
          </h3>
        </div>
        ...
        <div className="row gstRow" data-aos="fade-right" data-aos-delay="500">
          ...
          <div className="col-md-2 gstbg-6">
            ...
            <p>Change Company NameIN Received</p>
          </div>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Change Company Name can be obtained on the Change Company Name portal. One must
                apply for Change Company Name in Form REG-01 on the Change Company Name portal
                following steps outlined in our article “How to apply for Change Company Name
                Fillings?”. However, the Change Company Name services at
                ClearTax helps you to get your business Change Company Name registered and
                obtain your Change Company NameIN. Clear Change Company Name experts will guide you on the
                applicability and compliances under Change Company Name for your business and
                get your business registered under Change Company Name.
              </p>
        ...
        >
          ...
          >
            ...
            <h4>
              <span className="slash_right">Change Company Name Fees</span>
            </h4>
            <p>
              Change Company Name is a tedious 11 step process that involves the
              submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the Change Company
              Name law for obtaining Change Company Name on the Change Company
              Name portal on your own, you can save a huge time and effort by
              purchasing the Change Company Name plan with ClearTax.
            </p>
            <p>
              You can opt for Clear Change Company Name services where a Change
              Company Name Expert will assist you, end to end with Change
              Company Name.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Change Company Name
              </span>
            </h4>
            <p>
...
export default CompanyNameRemoval;

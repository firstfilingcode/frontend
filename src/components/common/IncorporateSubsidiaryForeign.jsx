...
function IncorporateSubsidiaryForeign() {
  return (
    <>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Advice & Guidance on Excise can be obtained on the GST portal. One must
                apply for Advice & Guidance on Excise in Form REG-01 on the GST portal
                following steps outlined in our article “How to apply for GST
                registration?”. However, the Advice & Guidance on Excise services at
...
export default IncorporateSubsidiaryForeign;

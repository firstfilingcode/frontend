      ...
      <div className="container">
          ...
          <div className="col-md-7">
            ...
            >
              <span className="secondrowheading slash_right">
                What is Investigation of Frauds?
              </span>
              <p className="Tax">
                Under Goods And Services Tax (Investigation of Frauds),
                businesses whose turnover exceeds the threshold limitof Rs.40
                lakh or Rs.20 lakh or Rs.10 lakh as the case may be, must
                register as a normal taxable person. It is called Investigation
                of Frauds.
              </p>
              <p>
                For certain businesses, Fillings under Investigation of Frauds
                is mandatory. If the organization carries on business without
                registering under Investigation of Frauds, it is an offence
                under Investigation of Frauds and heavy penalties will apply.
              </p>
              obtain Investigation of Frauds faster in 3 easy steps.
              <p />
              <p>
                Investigation of Frauds usually takes between 2-6 working days.
                Team Clear can help you obtain Investigation of Frauds faster in
                3 easy steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          ...
          >
            <h3 className="firstrowheadind slash_right">
              Investigation of Frauds Online
            </h3>
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Investigation of Frauds</li>
                <li>Secure Investigation of Frauds Identification Number</li>
                <li>
                  Dedicated manager to process your Investigation of Frauds end
                  to end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted Investigation of Frauds Filing for all your
                  Investigation of Frauds needs
                </li>
                <li>
                  CA Assisted Investigation of Frauds Filing for all your
                  Investigation of Frauds needs
            ...
            <p className="textdetail">
              * Get Clear Investigation of Frauds invoicing and digital khata
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Investigation of Frauds?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-Investigation of Frauds
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Investigation of Frauds Process</span>
            </div>
          </h3>
        </div>
        ...
        <div className="row gstRow" data-aos="fade-right" data-aos-delay="500">
          ...
          <div className="col-md-2 gstbg-6">
            ...
            <p>Investigation of FraudsIN Received</p>
          </div>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Investigation of Frauds can be obtained on the Investigation of Frauds portal. One must
                apply for Investigation of Frauds in Form REG-01 on the Investigation of Frauds portal
                following steps outlined in our article “How to apply for Investigation of Frauds
                Fillings?”. However, the Investigation of Frauds services at
                ClearTax helps you to get your business Investigation of Frauds registered and
                obtain your Investigation of FraudsIN. Clear Investigation of Frauds experts will guide you on the
                applicability and compliances under Investigation of Frauds for your business and
                get your business registered under Investigation of Frauds.
              </p>
          ...
          >
            <h4>
              <span className="slash_right">
                Documents Required for Investigation of Frauds
              </span>
            </h4>
            ...
            <h4>
              <span className="slash_right">Investigation of Frauds Fees</span>
            </h4>
            <p>
              Investigation of Frauds is a tedious 11 step process that involves
              the submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the Investigation of
              Frauds law for obtaining Investigation of Frauds on the
              Investigation of Frauds portal on your own, you can save a huge
              time and effort by purchasing the Investigation of Frauds plan
              with ClearTax.
            </p>
            <p>
              You can opt for Clear Investigation of Frauds services where a
              Investigation of Frauds Expert will assist you, end to end with
              Investigation of Frauds.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Investigation of Frauds
              </span>
            </h4>
            <p>

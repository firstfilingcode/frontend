          ...
          <div className="col-md-7">
            ...
            >
              <span className="secondrowheading slash_right">
                What is Private To OPC?
              </span>
              <p className="Tax">
                Under Goods And Services Tax (Private To OPC), businesses whose
                ...
                taxable person. It is called Private To OPC.
              </p>
              <p>
                For certain businesses, Fillings under Private To OPC is
                mandatory. If the organization carries on business without
                registering under Private To OPC, it is an offence under Private
                To OPC and heavy penalties will apply.
              </p>
              obtain Private To OPC faster in 3 easy steps.
              <p />
              <p>
                Private To OPC usually takes between 2-6 working days. Team
                Clear can help you obtain Private To OPC faster in 3 easy steps.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Private To OPC</li>
                <li>Secure Private To OPC Identification Number</li>
                <li>
                  Dedicated manager to process your Private To OPC end to end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted Private To OPC Filing for all your Private To OPC
                  needs
                </li>
                <li>
                  CA Assisted Private To OPC Filing for all your Private To OPC
            ...
            <p className="textdetail">
              * Get Clear Private To OPC invoicing and digital khata app free
              with this service
            </p>
          </div>
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Private To OPC?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-Private To OPC law (i.e.,
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Private To OPC Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Private To OPC can be obtained on the Private To OPC portal. One must
                apply for Private To OPC in Form REG-01 on the Private To OPC portal
                following steps outlined in our article “How to apply for Private To OPC
                Fillings?”. However, the Private To OPC services at
                ClearTax helps you to get your business Private To OPC registered and
                obtain your Private To OPCIN. Clear Private To OPC experts will guide you on the
                applicability and compliances under Private To OPC for your business and
                get your business registered under Private To OPC.
              </p>
          ...
          >
            <h4>
              <span className="slash_right">
                Documents Required for Private To OPC
              </span>
            </h4>
            ...
            <h4>
              <span className="slash_right">Private To OPC Fees</span>
            </h4>
            <p>
              Private To OPC is a tedious 11 step process that involves the
              submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the Private To OPC law
              for obtaining Private To OPC on the Private To OPC portal on your
              own, you can save a huge time and effort by purchasing the Private
              To OPC plan with ClearTax.
            </p>
            <p>
              You can opt for Clear Private To OPC services where a Private To
              OPC Expert will assist you, end to end with Private To OPC.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Private To OPC
              </span>
            </h4>
            <p>

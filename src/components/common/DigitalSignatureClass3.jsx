      ...
      <div className="container">
          ...
          <div className="col-md-7">
            ...
            >
              <span className="secondrowheading slash_right">
                What is Change Company Address?
              </span>
              <p className="Tax">
                Under Goods And Services Tax (Change Company Address),
                businesses whose turnover exceeds the threshold limitof Rs.40
                lakh or Rs.20 lakh or Rs.10 lakh as the case may be, must
                register as a normal taxable person. It is called Change Company
                Address.
              </p>
              <p>
                For certain businesses, Fillings under Change Company Address is
                mandatory. If the organization carries on business without
                registering under Change Company Address, it is an offence under
                Change Company Address and heavy penalties will apply.
              </p>
              obtain Change Company Address faster in 3 easy steps.
              <p />
              <p>
                Change Company Address usually takes between 2-6 working days.
                Team Clear can help you obtain Change Company Address faster in
                3 easy steps.
              </p>
            </div>
          </div>
        ...
        <div className="row whatisgst">
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Change Company Address</li>
                <li>Secure Change Company Address Identification Number</li>
                <li>
                  Dedicated manager to process your Change Company Address end
                  to end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted Change Company Address Filing for all your Change
                  Company Address needs
                </li>
                <li>
                  CA Assisted Change Company Address Filing for all your Change
                  Company Address needs
            ...
            <p className="textdetail">
              * Get Clear Change Company Address invoicing and digital khata app
          ...
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Change Company Address?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-Change Company Address
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Change Company Address Process</span>
            </div>
          </h3>
        </div>
        ...
        <div className="row gstRow" data-aos="fade-right" data-aos-delay="500">
          ...
          <div className="col-md-2 gstbg-6">
            ...
            <p>Change Company AddressIN Received</p>
          </div>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Change Company Address can be obtained on the Change Company Address portal. One must
                apply for Change Company Address in Form REG-01 on the Change Company Address portal
                following steps outlined in our article “How to apply for Change Company Address
                Fillings?”. However, the Change Company Address services at
                ClearTax helps you to get your business Change Company Address registered and
                obtain your Change Company AddressIN. Clear Change Company Address experts will guide you on the
                applicability and compliances under Change Company Address for your business and
                get your business registered under Change Company Address.
              </p>
          ...
          >
            <h4>
              <span className="slash_right">
                Documents Required for Change Company Address
              </span>
            </h4>
            ...
            <h4>
              <span className="slash_right">Change Company Address Fees</span>
            </h4>
            <p>
              Change Company Address is a tedious 11 step process that involves
              the submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the Change Company
              Address law for obtaining Change Company Address on the Change
              Company Address portal on your own, you can save a huge time and
              effort by purchasing the Change Company Address plan with
              ClearTax.
            </p>
            <p>
              You can opt for Clear Change Company Address services where a
              Change Company Address Expert will assist you, end to end with
              Change Company Address.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Change Company Address
              </span>
            </h4>
            <p>
...
export default DigitalSignatureClass3;

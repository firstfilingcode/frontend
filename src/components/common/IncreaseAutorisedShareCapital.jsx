...
function IncreaseAutorisedShareCapital() {
  return (
    <>
      <div className="container">
          ...
          <div className="col-md-7">
            ...
            >
              <span className="secondrowheading slash_right">
                What is Audit of Accounts?
              </span>
              <p className="Tax">
                Under Goods And Services Tax (Audit of Accounts), businesses
                ...
                taxable person. It is called Audit of Accounts.
              </p>
              <p>
                For certain businesses, Fillings under Audit of Accounts is
                mandatory. If the organization carries on business without
                registering under Audit of Accounts, it is an offence under
                Audit of Accounts and heavy penalties will apply.
              </p>
              obtain Audit of Accounts faster in 3 easy steps.
              <p />
              <p>
                Audit of Accounts usually takes between 2-6 working days. Team
                Clear can help you obtain Audit of Accounts faster in 3 easy
                steps.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Audit of Accounts</li>
                <li>Secure Audit of Accounts Identification Number</li>
                <li>
                  Dedicated manager to process your Audit of Accounts end to end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted Audit of Accounts Filing for all your Audit of
                  Accounts needs
                </li>
                <li>
                  CA Assisted Audit of Accounts Filing for all your Audit of
            ...
            <p className="textdetail">
              * Get Clear Audit of Accounts invoicing and digital khata app free
              with this service
            </p>
          </div>
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Audit of Accounts?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-Audit of Accounts law
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Audit of Accounts Process</span>
            </div>
          </h3>
        </div>
        ...
        <div className="row gstRow" data-aos="fade-right" data-aos-delay="500">
          ...
          <div className="col-md-2 gstbg-6">
            ...
            <p>Audit of AccountsIN Received</p>
          </div>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Audit of Accounts can be obtained on the Audit of Accounts portal. One must
                apply for Audit of Accounts in Form REG-01 on the Audit of Accounts portal
                following steps outlined in our article “How to apply for Audit of Accounts
                Fillings?”. However, the Audit of Accounts services at
                ClearTax helps you to get your business Audit of Accounts registered and
                obtain your Audit of AccountsIN. Clear Audit of Accounts experts will guide you on the
                applicability and compliances under Audit of Accounts for your business and
                get your business registered under Audit of Accounts.
              </p>
          ...
          >
            <h4>
              <span className="slash_right">
                Documents Required for Audit of Accounts
              </span>
            </h4>
            ...
            <h4>
              <span className="slash_right">Audit of Accounts Fees</span>
            </h4>
            <p>
              Audit of Accounts is a tedious 11 step process that involves the
              submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the Audit of Accounts
              law for obtaining Audit of Accounts on the Audit of Accounts
              portal on your own, you can save a huge time and effort by
              purchasing the Audit of Accounts plan with ClearTax.
            </p>
            <p>
              You can opt for Clear Audit of Accounts services where a Audit of
              Accounts Expert will assist you, end to end with Audit of
              Accounts.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Audit of Accounts
              </span>
            </h4>
            <p>
...
export default IncreaseAutorisedShareCapital;

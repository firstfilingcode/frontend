          ...
          <div className="col-md-7">
            ...
            >
              <span className="secondrowheading slash_right">
                What is Private To LLP?
              </span>
              <p className="Tax">
                Under Goods And Services Tax (Private To LLP), businesses whose
                ...
                taxable person. It is called Private To LLP.
              </p>
              <p>
                For certain businesses, Fillings under Private To LLP is
                mandatory. If the organization carries on business without
                registering under Private To LLP, it is an offence under Private
                To LLP and heavy penalties will apply.
              </p>
              obtain Private To LLP faster in 3 easy steps.
              <p />
              <p>
                Private To LLP usually takes between 2-6 working days. Team
                Clear can help you obtain Private To LLP faster in 3 easy steps.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="gstlist_">
              <ul className="listing_second">
                <li>Filing of Application for Private To LLP</li>
                <li>Secure Private To LLP Identification Number</li>
                <li>
                  Dedicated manager to process your Private To LLP end to end
                </li>
                <li>Completely Online – No need to visit office</li>
                <li>
                  CA Assisted Private To LLP Filing for all your Private To LLP
                  needs
                </li>
                <li>
                  CA Assisted Private To LLP Filing for all your Private To LLP
            ...
            <p className="textdetail">
              * Get Clear Private To LLP invoicing and digital khata app free
              with this service
            </p>
          </div>
          <div className="col-md-6" data-aos="fade-left" data-aos-delay="500">
            <sapn className="secondrowheading slash_right">
              Who should obtain the Private To LLP?
            </sapn>
            <div className="gstlist_">
              <ul className="listing_second">
                <li>
                  Individuals registered under the Pre-Private To LLP law (i.e.,
        ...
        <div className="col-md-12 text-center mt-3">
          <h3>
            <div
              ...
              data-aos-delay="500"
            >
              <span>All About The Private To LLP Process</span>
            </div>
          </h3>
        </div>
          ...
          >
            <section className="gst-registration-padding">
              ...
              <p className="web-color gsttext2">
                Private To LLP can be obtained on the Private To LLP portal. One must
                apply for Private To LLP in Form REG-01 on the Private To LLP portal
                following steps outlined in our article “How to apply for Private To LLP
                Fillings?”. However, the Private To LLP services at
                ClearTax helps you to get your business Private To LLP registered and
                obtain your Private To LLPIN. Clear Private To LLP experts will guide you on the
                applicability and compliances under Private To LLP for your business and
                get your business registered under Private To LLP.
              </p>
          ...
          >
            <h4>
              <span className="slash_right">
                Documents Required for Private To LLP
              </span>
            </h4>
            ...
            <h4>
              <span className="slash_right">Private To LLP Fees</span>
            </h4>
            <p>
              Private To LLP is a tedious 11 step process that involves the
              submission of many business details and scanned documents.
            </p>
            <p>
              Although there are no fees prescribed under the Private To LLP law
              for obtaining Private To LLP on the Private To LLP portal on your
              own, you can save a huge time and effort by purchasing the Private
              To LLP plan with ClearTax.
            </p>
            <p>
              You can opt for Clear Private To LLP services where a Private To
              LLP Expert will assist you, end to end with Private To LLP.
            </p>
            <h4>
              <span className="slash_right">
                Penalty for not obtaining Private To LLP
              </span>
            </h4>
            <p>

...
import clientprofile from "../common/Images/user.jpg";
    ...
    const getData = () => {
        fetch(BASE_URL + "/getReferralCode/" + ReactSession.get("user_id"))
            ...
            .then((json) => {
                ...
                setReferralClient(json.referral_clients)
                setReferralContent(json.referral_content[0].refer_earn)
                // alert(JSON.stringify(json.referral_content[0].refer_earn))

                fetch(BASE_URL + "/getSetting")
                    .then((res) => res.json())
                    .then((json) => {
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-md-12 paddingtopBottom3">
                        ...
                        <p className="Referralp" dangerouslySetInnerHTML={{ __html: referralContent }}></p><br />
                         </div>
                  ...
                  ""
                    ...
                    <a
                    href={"https://wa.me/91"+setting.watsapp_link+"?text=" + array[0] + referral}
                    target="_blank" >
                  ...
                  ""
                    ...
                    <div className="social_boxes">
                    <a
                    href="https://www.facebook.com/sharer/sharer.php?u=https://firstfiling.in"
                    target="_blank" >
...
<svg xmlns="http://www.w3.org/2000/svg" class="bi bi-whatsapp" viewBox="0 0 16 16">
                  ...
                  ""
                    ...
                    <div className="social_boxes">
                    <a
                    href={"https://instagram.com/_u/"+setting.instagram_link}
                    target="_blank" >
...
<svg xmlns="http://www.w3.org/2000/svg" class="bi bi-whatsapp" viewBox="0 0 16 16">
                        ...
                        <div className="col-md-12 paddingtopBottom3">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-8">
                                {referralClient.map((item) => {
                                                        return (
                                                            <>
                                    <section 
                                    className="scrollerHappy"
                                    >
                                            ...
                                            <div className="card-body">
                                                ...
                                                <div className="row">
                                                                ...
                                                                <div className="col-md-10">
                                                                    <span className="referdescriptioNText">{item.refer_by}</span>
                                                                    <p className="referdescriptioNText">Referral Code Used On {item.created_at} at {item.time_at} </p>
                                                                </div>

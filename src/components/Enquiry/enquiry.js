...
const Enquiry = () => {
  ...
  const query = [
    "ResidentsForeignIncomeTaxReturns",
    "SalariedIndivual",
    "RevisedIncomeTaxReturnFiling",
    "LtcgAdvisory",
    "NRITaxReturn",
    "AdvanceTaxCalculation",
    "PresumptiveIncomeTaxFiling",
    "TaxFilingSaleShares",
    "TaxFilingTrandingForeignStocks",
    "IndividualTaxFilingPlan",
    "CapitalGainsTaxReliefSection89",
    "LongTermCapitalGans",
    "PartnershipFirmtoLLP",
    "TaxNoticeManagement",
    "RevisedIncomeTaxReturnFiling2",
    "TaxFillingGainsCryptocurrencyIndividual",
    "TaxFillingCryptocurrencyTrading",
    "LiveFilingSalariedEmployee",
    "LiveBusinessTaxReturns",
    "TaxFilingSecuritiesTraders",
    "BusinessTaxReturnsCorporateEntities",
    "LivePresumptiveIncomeTaxFiling",
    "LiveNriTaxReturnFiling",
    "LiveIndividualTaxFiling",
    "TaxFillingGainsCryptocurrencyBusinessPremium",
    "Itr1",
    "Itr2",
    "Itr3",
    "Itr4",
  ...
  return (
    <>
      <div
        id="display1"
        className="ordersection2 ItrChangeinput"
        data-aos="fade-right"
        data-aos-delay="600"
      >
        <p className="incometaxquery">File your Income Tax Return with</p>
        <section className="text-center mb-3">
          <img src={firstfillingimg} alt="firstfilling image" />
        </section>
        <p className="inrTEtx">@ INR {price}/- only</p>
      ...
      <div
        id="display2"
        className="ordersection contactinput"
        data-aos="fade-right"
        data-aos-delay="600"
      >
        <Form onSubmit={submitForm} className="fillform">
          <div class="input-group">
            <div class="input-group-prepend LoginICons3">
              <span class="input-group-text" id="">
                <i class="fa fa-user"></i>
